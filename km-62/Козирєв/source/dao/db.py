...
from root.dao.credentials import *
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            try:
                ...
                print("Connection created to DB: {}".format(db_version[0]))
                ...
                Database._instance.connection = connection
                Database._instance.cursor = cursor
